...
#include <stdio.h>
#line 1 "../../Runtime/lemon/cfg.y"
#include <assert.h>
#line 2 "../../Runtime/lemon/cfg.y"
#include <stdlib.h>
#line 3 "../../Runtime/lemon/cfg.y"
#include <string.h>
#line 14 "../../Runtime/lemon/cfg.c"
...
#endif
#define ParseARG_SDECL CodeGenerator *cg;
#define ParseARG_PDECL ,CodeGenerator *cg
#define ParseARG_FETCH CodeGenerator *cg = yypParser->cg
#define ParseARG_STORE yypParser->cg = cg
#define YYNSTATE 14
#define YYNRULE 6
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    14,    2,    1,   21,    4,   11,    9,    7,   10,   13,
 /*    10 */     1,    6,    3,    5,    8,   12,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    1,    2,    9,   10,    6,    7,    3,   10,    3,
 /*    10 */     2,   10,    5,   11,    4,    3,
};
#define YY_SHIFT_USE_DFLT (-2)
#define YY_SHIFT_MAX 9
static const signed char yy_shift_ofst[] = {
 /*     0 */     4,    4,    4,    6,    0,   -1,    8,   10,    7,   12,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    20,   20,   20,   20,   20,   20,   16,   20,   20,   20,
 /*    10 */    15,   17,   18,   19,
};
...
static const char *const yyTokenName[] = { 
  "$",             "OR",            "AND",           "NAME",        
  "IN",            "LPAREN",        "RPAREN",        "COMMA",       
  "error",         "line",          "expr",          "states",      
};
#endif /* NDEBUG */
