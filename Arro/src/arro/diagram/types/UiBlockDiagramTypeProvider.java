 ...
 *
 */
public class UiBlockDiagramTypeProvider extends AbstractDiagramTypeProvider {
	
	private static HashMap<Diagram, UiBlockDiagramTypeProvider> diagrams = new HashMap<Diagram, UiBlockDiagramTypeProvider>();
	public UiBlockDiagramTypeProvider() {
		super();
		setFeatureProvider(new UiBlockDiagramFeatureProvider(this));
